        ...
        <div className="flex space-x-4">
          ...
          <Dialog open={isPostFormOpen} onOpenChange={setIsPostFormOpen}>
            <DialogTrigger className="w-full">
              <div className="flex items-center justify-between">
                <Input
                  ...
                  readOnly
                  className="cursor-pointer rounded-full sm:h-12  dark:bg-[rgb(58,59,60)] placeholder:text-gray-500 dark:placeholder:text-gray-400  "
                />
              ...
              <Separator className="my-2 dark:bg-slate-400 hidden sm:block" />
            ...
            <DialogContent className="sm:max-w-[525px] max-h-[80vh] overflow-y-auto">
              ...
              <Textarea
                placeholder={`what's on your mind?`}
                className="max-h-12 sm:min-h-[100px] text-lg"
                value={postContent}
